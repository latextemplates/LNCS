...
\href{https://github.com/gpoore/minted}{minted} as an alternative package, which enables syntax highlighting using \href{http://pygments.org/}{pygments}.
This, in turn, requires Pytton, so it is disabled by default.
