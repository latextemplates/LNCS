...
\iftrue % use default-font
  \ifluatex
    % no special pre-cautions. See https://tex.stackexchange.com/a/419223/9075
  \else
...
In case LuaLaTeX is used as compiler, there is no ligature at \qq{f\/l} in the word \qq{dwarflike} (in contrast to \qq{fl} in the word \qq{workflow}).
In other words: \qq{dwarflike} and \qq{dwarf\/like} look the same in the PDF (but are written \texttt{dwarflike} and \texttt{dwarf\textbackslash{}/like} in the PDF.
