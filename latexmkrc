...
$pdflatex = 'pdflatex --shell-escape --interaction nonstopmode --synctex=-1 %O %S | texlogsieve';
...
@generated_exts = qw(acn acr alg aux code ist fls glg glo gls glsdefs idx ind lof lot out thm toc tpt wrt upa upb synctex);
