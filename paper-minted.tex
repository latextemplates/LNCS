...
% This option is not present, since in most cases, letter format is produced.
% To prevent WTFs at persons not used to the A4 vs. letter argument, this option is not set.
...
% Currently not working - see https://tex.stackexchange.com/q/441670/9075
